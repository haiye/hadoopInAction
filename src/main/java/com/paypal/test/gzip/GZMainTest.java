...
public class GZMainTest {
    ...
    public static void main(String[] args) {
        ...
        if(args.length<2){
            ...
            System.out.println("args number should be even, like: filename beginIndex endIndex debginIndex endIndex true/false");
        }else{
            fileName=args[0];
        ...
        System.out.println("fileName="+fileName+" offsetBeginArray="+Arrays.toString(offsetBeginArray)+" offsetEndArray="+Arrays.toString(offsetEndArray)+" debug="+debug);

//        GZReader gzReaqder=  new GZReader(fileName, offsetBeginArray, offsetEndArray, debug);
//        
